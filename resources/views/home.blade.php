        ...
        <section class="deals_section sec_ptb_50 clearfix">
            <div class="container maxw_1460">
                <div class="row align-items-center">
                    <div class="col-lg-3">
                        <div class="supermarket_section_title clearfix clearfixsuper">
                            <span class="sub_title text-uppercase">A wide selection of items </span>
                            <h2 class="title_text mb-0">iPhone Series</h2>
                        </div>
                    </div>
    ...
    "infinite": true
                        ...
                        <div class="item col">
                            <div class="supermarket_deals_item text-center clearfix">
                                ...
                                {{-- <span class="item_price">Rs. 220,000</span> --}}
                            </div>
                        </div>
                        ...
                        <div class="item col">
                            <div class="supermarket_deals_item text-center clearfix">
                                ...
                                {{-- <span class="item_price">Rs. 180,000</span> --}}
                            </div>
                        </div>
   ...
   ================================================== -->
        <section class="bestseller_section sec_ptb_50 pb-0 clearfix">
            <div class="container maxw_1460">
                ...
                <div class="row mb_50 align-items-center justify-content-lg-between">
                    <div class="col-lg-5">
                        <div class="supermarket_section_title clearfix">
                            <span class="sub_title text-uppercase">A wide selection of items</span>
                            <h2 class="title_text mb-0">Accessories</h2>
                        </div>
                    </div>

                    <div class="col-lg-7 ">
                        <ul class="supermarket_tab_nav ul_li_right nav clearfix  accessoriese_more" role="tablist">
                            <li>
                                <a class="active" data-toggle="tab" href="#top_tab">More...</a>
                            </li>
                ...
                <div class="col-lg-7 ">
                    <ul class="supermarket_tab_nav ul_li_right nav clearfix  accessoriese_more_desk" role="tablist">
                        <li>
                            <a class="active" data-toggle="tab" href="#top_tab">More...</a>
                        </li>
